...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "JornadaAPI", Version = "v1" });
...
{
    builder.WithOrigins("http://localhost:7087", "http://192.168.1.109:7087").AllowAnyMethod().AllowAnyHeader();
}));
